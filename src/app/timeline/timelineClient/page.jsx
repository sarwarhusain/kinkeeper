...
const DetailTimeLine = () => {
  ...
  let friendsData = [...timeLine];
  if (filter) {
    friendsData = friendsData.filter((data) => data.type === filter);
  }
  if (sort === "goals") {
    friendsData.sort((a, b) => a.target - b.target);
  } else if (sort === "days") {
    friendsData.sort((a, b) => a.contact - b.contact);
  }
  ...
  return (
    <div className="">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-2 m-1">
